...
const sendNotificationApp = async (
  uids: string[],
  notification: ModelsFunctions.NotificationApp
) => {
...
const createNotificationDemo = (
  ...
  const demo: ModelsFunctions.NotificationApp = {
    ...
    descripcion:
      'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consectetur accusamus a ut explicabo molestiae, aspernatur iure laborum voluptates, aperiam culpa iste aut quis officiis praesentium alias obcaecati. Nam, unde minus!',
