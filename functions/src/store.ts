...
export const newPedido = onDocumentCreated(
  'Users/{userId}/pedidos/{pedidoId}',
  async (event) => {
    ...
    if (response.size) {
      ...
      console.log(
        ...
        responseNotifications.successCount
      );
    }
    return;
  }
...
export const cambioEstadoPedido = onDocumentUpdated(
  'Users/{userId}/pedidos/{pedidoId}',
  async (event) => {
