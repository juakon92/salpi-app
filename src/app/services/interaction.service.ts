...
import { AlertController, IonicSafeString, LoadingController, ToastController } from '@ionic/angular/standalone';
...
export class InteractionService {
  private loading: HTMLIonLoadingElement; // Almacena la referencia al elemento de carga
